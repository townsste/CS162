...
void Potter::combatRestHealth()
{
	...
	if (strength > 10 && extraLife == 1)
	{
		cout << "Potter's health is fully restored due to taking little damage to no" << endl;
		strength = 10;
	}
	else if (strength > 20 && extraLife == 0)
	{
		cout << "Potter's health is fully restored due to taking little damage to no" << endl;
		strength = 20;
	}
	else
		cout << "Potter restored " << restore << " Health" << endl;
